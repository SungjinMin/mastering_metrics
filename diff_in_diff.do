...
xi: reg mrate legal i.state i.year if year <= 1983 & agegr == 2 & dtype == 1
xi: reg mrate legal i.state i.year if year <= 1983 & agegr == 2 & dtype == 1, cluster(state)
xi: reg mrate legal i.state*year i.year if year <= 1983 & agegr == 2 & dtype == 1, cluster(state)
xi: reg mrate legal i.state*year i.year if year <= 1983 & agegr == 2 & dtype == 1 [aw=pop], cluster(state)
